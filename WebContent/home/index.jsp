...
<!-- 
   <nav id="sub_menu">
      <ul>      
         <li><a href="introduce.html">현재의 나</a></li>
         <li><a href="introduce.html">나의 어린시절</a></li>
         <li><a href="introduce.html">미래의 나</a></li>
      </ul>
   </nav>
-->
   <section id="sub_section">
      ...
      <div class="div">
		   ...
		   <button type="button" id="botton04"  onclick="location.href='../selftest/selftest.jsp?test_no=2'">손목터널 증후군</button>
